...
<template>
    <VueSelect v-model="selectedOption" :disabled="disabled" :placeholder="placeholder ?? 'Selecione uma Opção'"
        :options="selectOptions" label="texto" searchable :filterable="false" @update:model-value="updateModelValue"
        @search="onSearch">
