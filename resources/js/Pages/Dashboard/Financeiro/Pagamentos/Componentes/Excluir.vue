...
function submitExcluirPagamento() {
    router.visit(`/dashboard/financeiro/pagamentos/${props.pagamentoId}/excluir/`)
}
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <h1 class="modal-title fs-5" id="excluirModalLabel">Realmente Deseja Excluir esse Pagamento?</h1>
