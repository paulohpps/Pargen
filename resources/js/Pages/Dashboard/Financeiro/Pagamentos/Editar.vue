...
const form = useForm({
    ...
    categoria_id: props.pagamento.categoria_id,
    subcategoria_id: props.pagamento.subcategoria_id,
})

let subcategorias = ref(props.pagamento.categoria.subcategorias);
...
function salvarPagamento() {
    form.post(`/dashboard/financeiro/pagamentos/${props.pagamento.id}/salvar`);
}
</script>

<template>
    <DashboardLayout titulo="Editar Pagamento" categoriaPagina="financeiro" pagina="pagamentos">
