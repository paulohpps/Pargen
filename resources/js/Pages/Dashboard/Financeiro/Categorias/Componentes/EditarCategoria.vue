...
function submitEditarCategoria() {
    form.post(`/dashboard/financeiro/categorias/${props.categoriaId}/editar`
        , {
            preserveScroll: true,
            onSuccess: () => {
                form.reset();
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h1 class="modal-title fs-5" id="adicionarModalLabel">Editar Categoria</h1>
                    <button @click="closeModal()" type="button" class="btn-close" data-bs-dismiss="modal"
                        aria-label="Close"></button>
                </div>
                <form @submit.prevent="submitEditarCategoria">
